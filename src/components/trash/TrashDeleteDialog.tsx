...
// <== TRASH DELETE DIALOG PROPS ==>
interface TrashDeleteDialogProps {
  // <== DIALOG OPEN STATE ==>
  open: boolean;
  // <== RECORD STAGED FOR PERMANENT DELETION ==>
  record: TrashRecord | null;
  // <== TITLE TO DISPLAY FOR THE STAGED RECORD ==>
  itemTitle: string;
...
// <== TRASH DELETE DIALOG COMPONENT ==>
const TrashDeleteDialog = memo(
  ({
    open,
    record,
    itemTitle,
          ...
          {record && (
            <div className="px-5 py-4">
              <p className="text-sm text-muted-foreground">
                ...
                ? It will be removed from Trash and cannot be recovered.
              </p>
            </div>
          )}
          {/* FIXED FOOTER */}
...
TrashDeleteDialog.displayName = "TrashDeleteDialog";

// <== EXPORT ==>
export default TrashDeleteDialog;
