...
// <== EXPENDITURE DELETE DIALOG PROPS ==>
interface ExpenditureDeleteDialogProps {
  // <== DIALOG OPEN STATE ==>
  open: boolean;
  // <== EXPENDITURE RECORD TO DELETE ==>
  record: Expenditure | null;
...
// <== EXPENDITURE DELETE DIALOG COMPONENT ==>
const ExpenditureDeleteDialog = memo(
  ({
    open,
    record,
    isPending,
...
ExpenditureDeleteDialog.displayName = "ExpenditureDeleteDialog";

// <== EXPORT ==>
export default ExpenditureDeleteDialog;
