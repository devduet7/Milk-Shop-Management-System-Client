...
// <== STAFF DELETE DIALOG PROPS ==>
interface StaffDeleteDialogProps {
  // <== DIALOG OPEN STATE ==>
  open: boolean;
  // <== STAFF RECORD TO DELETE ==>
...
// <== STAFF DELETE DIALOG COMPONENT ==>
const StaffDeleteDialog = memo(
  ({ open, record, isPending, onClose, onConfirm }: StaffDeleteDialogProps) => {
...
StaffDeleteDialog.displayName = "StaffDeleteDialog";
