...
// <== MILK LOG DELETE DIALOG PROPS ==>
interface MilkLogDeleteDialogProps {
  // <== DIALOG OPEN STATE ==>
  open: boolean;
  // <== MILK LOG RECORD TO DELETE ==>
  record: MilkLog | null;
...
// <== MILK LOG DELETE DIALOG COMPONENT ==>
const MilkLogDeleteDialog = memo(
  ({
    open,
    record,
    isPending,
          ...
          {record && (
            <div className="px-5 py-4">
              <p className="text-sm text-muted-foreground">
                ...
                {record.type === "leftover" ? "leftover" : "yoghurt"} entry from{" "}
                <span className="font-semibold text-foreground">
                  {record.date}
                </span>
                ?
...
MilkLogDeleteDialog.displayName = "MilkLogDeleteDialog";

// <== EXPORT ==>
export default MilkLogDeleteDialog;
