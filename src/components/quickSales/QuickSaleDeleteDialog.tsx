...
// <== QUICK SALE DELETE DIALOG PROPS ==>
interface QuickSaleDeleteDialogProps {
  // <== DIALOG OPEN STATE ==>
  open: boolean;
  // <== QUICK SALE RECORD TO DELETE ==>
...
// <== QUICK SALE DELETE DIALOG COMPONENT ==>
const QuickSaleDeleteDialog = memo(
  ({
    open,
    record,
    isPending,
            ...
            <div className="px-5 py-4">
              <p className="text-sm text-muted-foreground">
                ...
                <span className="font-semibold text-foreground">
                  ...
                  {record.type === "milk" ? "L" : "kg"}{" "}
                  {record.type === "milk" ? "Milk" : "Yoghurt"}
                </span>{" "}
                sale from{" "}
                <span className="font-semibold text-foreground">
                  {record.date}
...
QuickSaleDeleteDialog.displayName = "QuickSaleDeleteDialog";

// <== EXPORT ==>
export default QuickSaleDeleteDialog;
