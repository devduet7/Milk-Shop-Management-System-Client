...
// <== CUSTOMER SALE TABLE VIEW PROPS ==>
interface CustomerSaleTableViewProps {
...
const CustomerSaleTableView = memo(
  ({
    sales,
    totalFiltered,
    isLoading,
...
CustomerSaleTableView.displayName = "CustomerSaleTableView";

// <== EXPORT ==>
export default CustomerSaleTableView;
