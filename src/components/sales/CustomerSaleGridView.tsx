...
// <== CUSTOMER SALE GRID VIEW PROPS ==>
interface CustomerSaleGridViewProps {
...
// <== CUSTOMER SALE GRID VIEW COMPONENT ==>
const CustomerSaleGridView = memo(
  ({
    sales,
    totalFiltered,
    isLoading,
    ...
    onEdit,
    onDelete,
  }: CustomerSaleGridViewProps) => {
    // RETURNING GRID VIEW
    return (
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
        {/* CUSTOMER SALE CARDS GRID */}
...
CustomerSaleGridView.displayName = "CustomerSaleGridView";

// <== EXPORT ==>
export default CustomerSaleGridView;
